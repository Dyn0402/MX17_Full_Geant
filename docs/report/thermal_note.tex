...
absorptions form a razor-thin shell hugging the inside of the entrance
hemisphere --- the rest of the gas never sees a neutron. By 0.1--1\,keV
the mean free path has grown to centimetres and the absorptions spread
through the volume (the surviving flux still thins visibly toward the top).
